...
var Tracker = function (outlet, pattern_markup, mgraphics) {
    ...
    */
    ...
    this.command = function(instruction){
        post('really here');
    ...
    this.set_rgb = function(color, dimming){
        mgraphics.set_source_rgba(color.r / dimming, color.g / dimming, color.b / dimming, 1);
    }

    this.make_empty_pattern = function(markup, ntracks){
    ...
    faux_pattern = this.make_empty_pattern(pattern_markup, 1);
    pattern_markup.data = faux_pattern;

    this.dictionary = function(dictName) {
    ...
    this.handle_2hex_input = function(key, caret, desciptor, pattern){
    ...
    this.handle_trigger_input = function(key, caret, desciptor, pattern){
    ...
    this.handle_ffxxyy_input = function(key, caret, desciptor, pattern, param_at_position){
        var hex_deletes = [46, 127];
    ...
    this.handle_4hex_input = function(key, caret, desciptor, pattern, param_at_position){
        var hex_deletes = [46, 127];
    ...
    this.handle_note_input = function(key, caret, desciptor, pattern){
    ...
    this.pattern_input_handler = function(key, caret, desciptor, pattern){
    ...
    this.corner_to_location = function(x, y){
        var _x = start_x + ((4 + x) * charwidth);
        var _y = start_y + (y * charheight);
        return [_x, _y];   
    }

    this.draw_caret = function(){
    ...
    this.draw_highlighted_lines = function(every_nth){
    ...
    this.draw_edit_mode_indicator = function(h){
    ...
    this.wheres_the_caret = function(){
    ...
    this.draw_track_descriptor = function(){
    ...
    this.handle_delete_selection = function(pattern){
    ...
    this.get_adjusted_selection_rect = function(){
        var selection =  this.getSelectionRect();
    ...
    this.handle_interpolate_selection = function(pattern){
        if (started_selection_mode){
            /*
    ...
    this.handle_copy_selection = function(pattern){
    ...
    this.handle_shift_selection = function(pattern, direction){
        if (started_selection_mode){
    ...
    this.handle_transpose_selection = function(pattern, direction){
    ...
    this.handle_paste_selection = function(pattern){
    ...
    this.keys = function(a1, a2, a3, a4) {
    ...
    this.draw_command_background = function(markup){
        /*
    ...
    this.draw_command_overlay = function(markup){
        /*
    ...
    this.paint = function(){
        ...
        this.draw_command_background(pattern_markup);
        this.draw_caret();
        ...
        this.draw_command_overlay(pattern_markup);  // if this is slowing stuff down, comment it out.
    ...
    this.find_cell_under_cursor = function(x, y){
    ...
    this.ondrag = function(x, y, button){
        return;
    }

    this.onidle = function(x, y, button, mod1, shift, caps, opt, mod2) { g_mouse_on_rect = true; }
    this.onidleout = function(x, y, button, mod1, shift, caps, opt, mod2) { g_mouse_on_rect = false; }
